...
protocol NetworkServiceType {
    ...
    func handleApiErrors(with statusCode: Int, and data: Data) -> DataResult
}
...
struct NetworkService: NetworkServiceType {
    ...
    @discardableResult
    func performRequest(route: NetworkRoute, completion: @escaping ((DataResult) -> Void)) -> DataRequest {
        session.request(route).responseData(emptyResponseCodes: emptyResponseStatusCodes) { response in
